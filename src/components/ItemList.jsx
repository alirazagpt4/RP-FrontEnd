...
//     }
//     return await axios.post(`/items/${id}/dispatch`, { action, courierSlip });
//   };
...
//     try {
//       setLoadingId(id);
//       const res = await axios.put(`/items/${id}`, { remarksWH: tempRemarks[id] });
//       if (res.data.success) {
...
//     try {
//       setLoadingId(id);
//       const res = await axios.put(`/items/${id}`, { remarksWH: remarkValue });
//       if (res.data.success) {
//         setMsg({ type: "success", text: "Remarks saved!" });
//         setActiveRemarksId(null);
//         fetchItems();
